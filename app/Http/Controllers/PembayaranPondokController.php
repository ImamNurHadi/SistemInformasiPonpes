...
class PembayaranPondokController extends Controller
{
    public function index()
    {
        $tingkatan = MasterTingkatan::all();
        return view('pembayaran.pondok.index', compact('tingkatan'));
    }
    ...
    public function search(Request $request)
    {
        ...
        $santri = $query->get();
        return view('pembayaran.pondok.index', compact('santri', 'tingkatan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            PembayaranSantri::create([
                'santri_id' => $santri->id,
                'jenis_pembayaran' => 'pondok',
                'keterangan' => $request->keterangan ?? 'Pembayaran Pondok',
                'jumlah' => $jumlah,
            ]);
            ...
            return redirect()->route('pembayaran-pondok.index')->with('success', 'Pembayaran pondok berhasil dilakukan');
        } catch (\Exception $e) {
            DB::rollBack();
