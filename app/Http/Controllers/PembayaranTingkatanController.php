...
class PembayaranTingkatanController extends Controller
{
    public function index()
    {
        $tingkatan = MasterTingkatan::all();
        return view('pembayaran.tingkatan.index', compact('tingkatan'));
    }
    ...
    public function search(Request $request)
    {
        ...
        $santri = $query->get();
        return view('pembayaran.tingkatan.index', compact('santri', 'tingkatan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            PembayaranSantri::create([
                'santri_id' => $santri->id,
                'jenis_pembayaran' => 'tingkatan',
                'keterangan' => $request->keterangan ?? 'Pembayaran Tingkatan',
                'jumlah' => $jumlah,
            ]);
            ...
            return redirect()->route('pembayaran-tingkatan.index')->with('success', 'Pembayaran tingkatan berhasil dilakukan');
        } catch (\Exception $e) {
            DB::rollBack();
