...
class PembayaranKamarController extends Controller
{
    public function index()
    {
        ...
        return view('pembayaran.kamar.index', compact('tingkatan'));
    }
    ...
    public function search(Request $request)
    {
        ...
        $santri = $query->get();
        return view('pembayaran.kamar.index', compact('santri', 'tingkatan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            PembayaranSantri::create([
                ...
                'keterangan' => $request->keterangan ?? 'Pembayaran Kamar',
                'jumlah' => $jumlah,
            ]);
            ...
            return redirect()->route('pembayaran-kamar.index')->with('success', 'Pembayaran kamar berhasil dilakukan');
        } catch (\Exception $e) {
            DB::rollBack();
